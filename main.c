/**
 * Parsing Language from the Prompt with the base Polish Notation Grammar.
 * 
...
// Function to delete lval* to release memory acquired from `malloc`
void lval_del(lval* v) {
  switch (v->type) {
    // Do nothing if input is number
    case LVAL_NUM:
      break;
...
// Add element to an S-Expression to increase count of Expression list by one
...
// Seperate first element of expression
...
// Deletes list that has extracted the element from
